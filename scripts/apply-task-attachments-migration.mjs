/**
 * Применяет supabase/add_task_attachments.sql (нужен SUPABASE_ACCESS_TOKEN).
 */
...
const sqlPath = path.join(root, "supabase", "add_task_attachments.sql");
...
console.log("Миграция вложений задач и bucket task-attachments применена (или уже актуальна).");
if (text && text !== "{}") {
