/**
 * Применяет supabase/add_task_card_color.sql (нужен SUPABASE_ACCESS_TOKEN).
 */
...
const sqlPath = path.join(root, "supabase", "add_task_card_color.sql");
...
console.log("Колонка tasks.card_color добавлена / уже существует.");
if (text && text !== "{}") {
