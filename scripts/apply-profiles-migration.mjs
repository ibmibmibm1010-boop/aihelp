/**
 * Применяет supabase/create_profiles.sql (нужен SUPABASE_ACCESS_TOKEN).
 */
...
const sqlPath = path.join(root, "supabase", "create_profiles.sql");
...
console.log("Таблица profiles создана / обновлена.");
if (text && text !== "{}") {
