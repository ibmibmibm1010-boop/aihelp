/**
 * Применяет supabase/create_board_columns.sql (нужен SUPABASE_ACCESS_TOKEN).
 */
...
const sqlPath = path.join(root, "supabase", "create_board_columns.sql");
...
console.log("Таблица board_columns и column_id в tasks применены.");
if (text && text !== "{}") {
