/**
 * Применяет supabase/add_board_column_section.sql (нужен SUPABASE_ACCESS_TOKEN).
 */
...
const sqlPath = path.join(root, "supabase", "add_board_column_section.sql");
...
console.log("Поле section для board_columns применено.");
if (text && text !== "{}") {
