/**
 * Применяет supabase/fix_boards_rls_recursion.sql (нужен SUPABASE_ACCESS_TOKEN).
 */
...
const sqlPath = path.join(root, "supabase", "fix_boards_rls_recursion.sql");
...
console.log("RLS для boards / board_members обновлён (без рекурсии).");
if (text && text !== "{}") {
